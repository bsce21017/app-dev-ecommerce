...
const data = [
  {
    title: 'Today',
    data: [
      { id: '1', storeName: 'Store 1', message: 'last message showing up there...', image: image3 },
      { id: '2', storeName: 'Store 2', message: 'last message showing up there...', image: image3 },
    ],
  },
  {
    title: 'Yesterday',
    data: [
      { id: '3', storeName: 'Store 3', message: 'last message showing up there...', image: image3 },
      { id: '4', storeName: 'Store 4', message: 'last message showing up there...', image: image3 },
    ],
  },
  {
    title: '08/03/2025',
    data: [
      { id: '5', storeName: 'Store 5', message: 'last message showing up there...', image: image3 },
      { id: '6', storeName: 'Store 6', message: 'last message showing up there...', image: image3 },
    ],
  },
];
