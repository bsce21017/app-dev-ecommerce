...
const image4= require('./assets/heart.png')
const image5= require('./assets/heart1.png')
const image6= require('./assets/played.png')
...
const DATA = 
    [
        { id: "Focus Attention" ,name:"10 MIN"},{ id: "Body Scan" ,name:"5 MIN"},{ id: "Making Happiness" ,name:"3 MIN"}
        ]
  ;
...
//        <View>
//        <Text style={{paddingLeft:20,fontWeight:500,fontSize:16}}>{item.id}</Text>
//        <Text style={{paddingLeft:19,fontWeight:500,color:'#A1A4B2',fontSize:16}}>{item.name}</Text>
//        </View>
//     </View>
//     <View style={{paddingLeft:10,paddingRight:10,backgroundColor:'#E4E6FD',height:1,width:"95%"}}></View>
//     </View>
//   );
// }
  return (
...
//       <Pressable style={styles.toggleButton} onPress={toggleDropdown}>
//         <Text style={styles.toggleButtonText}>Toggle Dropdown</Text>
//       </Pressable>
...
// <Pressable style={{justifyContent:'space-between',flexDirection:'row',borderWidth:1,borderColor:"#e7c574",borderRadius:5,width:55,paddingLeft:5,paddingBottom:2,paddingRight:5}}onPress={toggleDropdown}>
//                 <Text style={{color:"#e7c574"}}>Size</Text>
