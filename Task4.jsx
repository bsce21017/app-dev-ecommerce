    ...
    <View style={{ flex: 1,padding:0, backgroundColor: 'black' }}>
      ...
      <View style={{padding:15,paddingTop:20,flex:0.1,backgroundColor:"black"}}>
        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
          <Text style={{color:"#e7c574",fontSize:40,fontFamily:"Pacifico"}}>MY WISHLIST</Text>
      ...
      <View style={{flex:1.5,backgroundColor:"black",justifyContent:"space-between"}}>
        ...
        <FlatList
          ...
          <View style={{padding:10,paddingRight:20,backgroundColor:"#e7c574",height:50,width:400,alignItems:"center",justifyContent:'center',flexDirection:'row'}}>
